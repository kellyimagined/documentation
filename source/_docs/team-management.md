...
<h3>Note</h3>All users can be removed except the site owner.</div>
...
<div class="alert alert-info" role="alert">
<h3>Note</h3>Only the current site owner has the ability to assign a new owner; site team members will not see this option.</div>
...
<div class="alert alert-info" role="alert">
<h3>Note</h3>Because Supporting Organizations have full access to a site, only the site owner can perform this action.</div>
